...
export const ProjectModal: React.FC<ProjectModalProps> = ({
  ...
  const renderRPGContent = () => {
    return (
      <div className="bg-[#151821] border-4 border-[#d4af37] p-6 max-h-[85vh] overflow-y-auto pixel-border-gold max-w-3xl w-full mx-4 relative">
        {/* Close Button */}
        <button 
          onClick={onClose}
          className="absolute top-4 right-4 border-2 border-[#4c566a] bg-[#2e3440] hover:border-[#ff4757] p-1 font-press text-[8px] text-white hover:text-[#ff4757] cursor-pointer
        ...
        {/* Modal Header */}
        <div className="mb-6 border-b-4 border-[#2e3440] pb-4 pr-8">
          ...
          <h2 className="font-press text-base text-[#d4af37] mb-2 leading-relaxed uppercase select-none">
            ⚔️ QUEST: {project.name}
          </h2>
          <p className="font-vt text-lg text-[#a0aec0] mt-1">
            <span className="text-[#ff4757]">ROLE:</span> {project.role}
          </p>
        </div>
        ...
        <div className="space-y-6 text-[#ededed]">
          ...
          <div>
            ...
            <p className="font-vt text-lg leading-relaxed text-zinc-300">
              {project.description}
            </p>
          </div>
          ...
          {project.architectureNotes && (
            <div>
              ...
              <p className="font-vt text-lg leading-relaxed text-zinc-300 bg-[#0b0c10] border-2 border-[#2e3440] p-3">
                {project.architectureNotes}
              </p>
            </div>
          )}
            ...
            <div>
              ...
              <div className="space-y-4">
                {project.technicalChallenges.map((challenge, idx) => (
                  <div 
                    key={idx} 
                    className="border-2 border-[#ff4757]/40 bg-[#ff4757]/5 p-4 shadow-[inset_0_0_10px_rgba(255,71,87,0.1)]"
                  >
                    <h4 className="font-press text-[8px] text-[#ff4757] mb-2 uppercase leading-normal">
                      BOSS: {challenge.title}
                    </h4>
                    <p className="font-vt text-base text-zinc-300 mb-2 leading-relaxed">
          ...
          {project.lessonsLearned && project.lessonsLearned.length > 0 && (
            <div>
              <h3 className="font-press text-[10px] text-[#d4af37] mb-2 uppercase tracking-wide flex items-center gap-1">
                <Trophy className="w-3.5 h-3.5 text-[#d4af37]" /> GUILD EXPERIENCE GAINED
              </h3>
        ...
        {/* Modal Actions */}
        <div className="mt-8 pt-4 border-t-4 border-[#2e3440] flex flex-wrap gap-3">
